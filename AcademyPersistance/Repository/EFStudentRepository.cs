...
namespace AcademyEFPersistance.Repository {
	public class EFStudentRepository : EFCrudRepository<Student, long>, IStudentRepository
	{
        ...
        public Enrollment FindEnrollmentByStudentIdAndEditionId(long studentId, long editionId)
        {
			return ctx.Enrollments.SingleOrDefault(e => e.StudentId == studentId && e.CourseEditionId == editionId);
        }
